...
public class backreg extends AsyncTask<String,Void,String> {

    AlertDialog dialog;
    Context context;
    public backreg(Context context)
    {
    ...
    protected String doInBackground(String... voids) {
        ...
        String connstr = "http://192.168.43.64/register.php";
        ...
        try {
            ...
            String data = URLEncoder.encode("doctorname","UTF-8")+"="+URLEncoder.encode(na,"UTF-8")
                    ...
                    +"&&"+URLEncoder.encode("city","UTF-8")+"="+URLEncoder.encode(ci,"UTF-8")
